				...
				<p>
					<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" align="center">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="static/img/cuadrolog1.png" class="d-block" height="500">
							</div>
							<div class="carousel-item">
								<img src="static/img/cuadrolog2.png" class="d-block" height="500">
							</div>
							<div class="carousel-item">
								<img src="static/img/cuadrolog3.png" class="d-block" height="500">
							</div>
						</div>
					...
					<div class="card mb-3">
						<div class="row g-0" style="background-color: #DADED6;">
							<div class="col-md-4">
								<form class="row g-3" name="contacto" method="POST" action="menu.php">
							...
							<div class="col-md-8" style="color: #56A308;">
								<div class="card-body" align="justify">
                                    ...
                                    Elaboramos cuadros decorativos de todos los tamaños y diseños, de muy buena calidad 
                                    <br>
                                    En casa siempre estamos buscando ese elemento que complemente nuestra decoración, los cuadros decorativos son excelentes ideas para que las 
                                    paredes en casa se muestren un poco más llamativas, si tener que pintarlas. La gran ventaja de los cuadros es si ya no nos agradan, los 
                                    cambiamos y queda listo.
                                    <br>
                                    Los cuadros decorativos aportan un equilibrio estético <br>
                                    Es a través de los cuadros que podemos dar coherencia al diseño de una habitación, los toques finales a una pared en blanco o un toque de 
                                    personalidad a una zona neutral. Descubre cómo los muebles decorativos también pueden ser una obra de arte funcional.
									</div>
								</div>
							</div>
						</div>
