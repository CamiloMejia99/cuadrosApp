...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="templates/precio.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="templates/contactos.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="templates/quejas.php" class="nav-link">
    ...
    <section class="content">
        ...
        <div id="contenedor" class="col-12" align="center">
            <img src="static/img/logoCuadros.png" alt="C&C" width="300" height="300">
        </div>
